...
>>>>>>> 93b9b89ab762647361309de61ecc0f84ef4acb00:dbk_tools/dbk_posts.py
	...
	for job in current_job_file:
		post_string = POST_TEMPLATE + post_string
		post_string = post_string + str(job["title"]) + " " + str(job["location"]) + "\n" + str(job["url"])
		post_string = post_string + "\nThis post has been generated by a python script. Interested in the code? The project can be view on github, {}".format(
			"https://github.com/tekksparrow/dbk-jobs-on-linkedin")
		print (str(counter))
		counter += 1
		print (post_string)
<<<<<<< HEAD:hello.py
